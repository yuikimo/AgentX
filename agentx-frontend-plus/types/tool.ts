...
export type ToolConfigStatus = "UNCONFIGURED" | "CONFIGURED" | "INVALID";

export interface InstallFieldDefinition {
  name: string;
  label?: string;
  type?: "string" | "secret" | "number" | "boolean" | string;
  required?: boolean;
  sensitive?: boolean;
  description?: string;
  placeholder?: string;
...
export interface InstallFieldsConfig {
  fields?: InstallFieldDefinition[];
}

export interface ConfigureToolParams {
  installValues: Record<string, any>;
}
