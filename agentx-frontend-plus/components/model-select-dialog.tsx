...
export function ModelSelectDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[78vh] flex flex-col overflow-hidden">
        <DialogHeader>
        ...
        <Tabs defaultValue="modelSelect" className="w-full mt-4 flex-1 min-h-0 flex flex-col">
          <TabsList className="shrink-0 grid w-full grid-cols-3 rounded-xl bg-muted p-1 h-auto">
            <TabsTrigger
              value="modelSelect"
              className="h-9 rounded-lg text-sm data-[state=active]:bg-background data-[state=active]:shadow-sm"
            >
              模型选择
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="modelSelect" className="pt-3 flex-1 min-h-0">
            {loading ? (
          ...
          <TabsContent value="modelParams" className="py-4 flex-1 min-h-0">
            <ScrollArea className="h-full pr-4">
          ...
          <TabsContent value="tokenStrategy" className="py-4 flex-1 min-h-0">
            <ScrollArea className="h-full pr-4">
