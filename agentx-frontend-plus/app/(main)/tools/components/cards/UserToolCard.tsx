...
interface UserToolCardProps {
  ...
  onConfigureClick?: (tool: UserTool, e: React.MouseEvent) => void;
}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 flex-1 min-w-0" onClick={() => onCardClick(tool)} style={{ cursor: 'pointer' }}>
            ...
            <div className="w-[calc(100%-60px)] min-w-0">
              ...
              {!tool.isOwner && tool.configStatus === "UNCONFIGURED" && !tool.deleted && (
                <div className="mt-1">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              {!tool.isOwner && onConfigureClick && !tool.deleted && (
                <DropdownMenuItem onClick={(e) => onConfigureClick(tool, e as unknown as React.MouseEvent)}>
