      ...
      if (createdToolsResponse.code === 200) {
        ...
        apiUserTools = toolsList.map((tool: any) => {
          ...
          const processedTool: UserTool = {
            ...
            installCommand: tool.installCommand || tool.install_command,
            installTemplate: tool.installTemplate,
            installFields: tool.installFields,
            configStatus: tool.configStatus,
