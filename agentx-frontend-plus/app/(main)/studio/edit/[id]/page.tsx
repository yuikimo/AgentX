...
export default function EditAgentPage() {
  ...
  const autoOpenWorkspaceModelDialog = searchParams.get("openModelDialog") === "1"
  ...
  const handlePublishVersion = async () => {
    ...
    try {
      ...
      const response = await publishAgentVersionWithToast(agentId, {
        ...
        multiModal: initialData.multiModal,
      })
  ...
  const rollbackToVersion = async (version: AgentVersion) => {
    ...
    try {
      const formData: AgentFormData = {
        ...
        multiModal: Boolean(version.multiModal),
      }
  ...
  const handleCancel = () => {
    ...
    <>
      <AgentFormModal
        ...
        title="编辑助理"
        autoOpenWorkspaceModelDialog={autoOpenWorkspaceModelDialog}
