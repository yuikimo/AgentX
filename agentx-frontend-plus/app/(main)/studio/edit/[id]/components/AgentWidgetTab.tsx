...
import { AgentWidgetService, toggleWidgetStatusWithToast, deleteWidgetWithToast } from "@/lib/agent-widget-service";
import { getAllModels } from "@/lib/user-settings-service";
...
export function AgentWidgetTab({ agentId }: AgentWidgetTabProps) {
  ...
  const loadWidgets = async () => {
    setLoading(true);
    try {
      const response = await AgentWidgetService.getWidgets(agentId);
