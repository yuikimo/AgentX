package com.example.agentx.domain.container.model;
...
import com.example.agentx.infrastructure.converter.ContainerStatusConverter;
...
/** 容器实体 */
@TableName(value = "user_containers", autoResultMap = true)
