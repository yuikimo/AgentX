...
public class ToolVersionEntity extends BaseEntity {
    ...
    /** 公开安装模板，不包含发布者私有参数 */
    @TableField(value = "install_template", typeHandler = com.example.agentx.infrastructure.converter.MapConverter.class)
    private Map<String, Object> installTemplate;

    /** 用户可配置字段定义 */
    @TableField(value = "install_fields", typeHandler = com.example.agentx.infrastructure.converter.MapConverter.class)
