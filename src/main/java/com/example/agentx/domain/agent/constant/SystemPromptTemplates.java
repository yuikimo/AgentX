package com.example.agentx.domain.agent.constant;
...
public class SystemPromptTemplates {
     ...
     * 系统提示词生成的模板
     */
    public static final String SYSTEM_PROMPT_GENERATION_TEMPLATE = "你是一位顶级的AI " +
            "Agent设计师。你的任务是基于下方提供的助手概览信息，为它编写一份高质量、结构化的宪法系统提示词。请使用XML标签来确保清晰度。\n\n"
