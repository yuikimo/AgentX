...
public class VectorStoreResult implements Serializable {
    ...
    /** 命中时使用的阈值 */
    private Double matchedMinScore;
    ...
    public Double getMatchedMinScore() {
        return matchedMinScore;
    }

    public void setMatchedMinScore(Double matchedMinScore) {
        this.matchedMinScore = matchedMinScore;
    }
