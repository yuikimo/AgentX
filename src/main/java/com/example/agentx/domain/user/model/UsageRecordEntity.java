...
import com.example.agentx.infrastructure.converter.QuantityDataConverter;
...
public class UsageRecordEntity extends BaseEntity {
    ...
    public static UsageRecordEntity createNewWithBusinessInfo(String userId, String productId,
                                                              Map<String, Object> quantityData, BigDecimal cost,
                                                              String requestId, String serviceName, String serviceType,
                                                              String serviceDescription, String pricingRule,
